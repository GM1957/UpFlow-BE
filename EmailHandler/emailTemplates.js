...
class SignUpEmailTemplate extends BaseEmailTemplate {
  constructor({
    ...
    super({
      subject: "Your confirmation link for signing-up in UpFlow",
      smsMessage: "Your confirmation link for signing-up in UpFlow",
      htmlContent: `<p>Hi There!</p>
                    <p>We are happy to have you here.</p>
                    <p>Your next step is to confirm your sign-up for UpFlow by clicking this <a href="${verifyUrl}" target="_blank">confirmation link</a></p>
                    <p>See you soon in the UpFlow portal!</p>
                    <p>Best,<br />Team UpFlow</p>
...
class ForgotPasswordEmailTemplate extends BaseEmailTemplate {
  constructor({
    ...
    super({
      subject: "Your verification code to reset password for UpFlow",
      ...
      <p>You are receiving this email because a request was made to reset the password for your UpFlow account.</p>
      <p>If you did not initiate this password reset, please contact us at UpFlow.com.</p>
      <p>Best Regards,<br />Team UpFlow</p>`
    });
    this.name = name;
...
class ConfirmForgotPasswordTemplate extends BaseEmailTemplate {
  constructor({ name = requiredParam("name") }) {
    super({
      subject: "[UpFlow] Your password was successfully reset",
      smsMessage: `hi ${name} your password has changed`,
      htmlContent: `<p>Hi ${name}</p>
      <p>This is to confirm that you've successfully changed your password for UpFlow</p>
      <p>Didn't do this? Be sure to change your password right away!</p>
      <p>Best Regards, <br />UpFlow team</p>`
    });
    this.name = name;
  }
}
